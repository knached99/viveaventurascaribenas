            ...
            <tr>
                <td>
                    <?php if($tripPhotos && is_array($tripPhotos) && count($tripPhotos) > 1): ?>
                        <div id="carousel-<?php echo e($trip->tripID); ?>" class="carousel slide" data-bs-ride="carousel">
...
<?php /**PATH /Applications/MAMP/htdocs/viveaventurascaribenas/resources/views/components/admincomponents/all-trips.blade.php ENDPATH**/ ?>