<footer class="ftco-footer bg-bottom" style="background-image: url(<?php echo e(asset('assets/images/footer-bg.jpg')); ?>);">
    <div class="container">
        <div class="row mb-5">
            <div class="col-md">
                ...
                <div class="ftco-footer-widget mb-4">
                    ...
                    <div class="block-23 mb-3">
                        <ul>
                            ...
                            <li><a href="<?php echo e(route('contact')); ?>"><span class="icon icon-envelope"></span><span
        ...
        <div class="row">
            <div class="col-md-12 text-center">
                ...
                <p style="visibility: hidden;">
                    ...
                    <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
                    Icons are not owned by <?php echo e(config('app.name')); ?> The 404 illustration is owned by <a
...
<?php /**PATH /Applications/MAMP/htdocs/viveaventurascaribenas/resources/views/components/travelcomponents/footer.blade.php ENDPATH**/ ?>