            ...
            <div class="col-md-8">
                ...
                <div class="trip-details">
                    ...
                    <div class="star-rating mb-3 text-dark">
                        ...
                        <span class="text-dark">(<?php echo e(number_format($averageTestimonialRating, 1)); ?> / 5.0)</span>
                    ...
                    <span class="trip-price text-dark">$<?php echo e(number_format($trip->tripPrice, 2)); ?> /person</span>
                    ...
                    <p class="trip-description" style="color: #000;"><?php echo e($trip->tripDescription); ?></p>
                    <ul class="trip-info">
                        <li style="color: #000; font-weight: bold;"><img
                                src="<?php echo e(asset('assets/images/calendar.png')); ?>" class="icon" />
                        ...
                        <?php switch($trip->tripLandscape):
                            case ('Beach'): ?>
                                <li class="text-dark" style="font-weight:bold;"><img
                                        src="<?php echo e(asset('assets/images/beach.png')); ?>" class="icon" />
                                    <?php echo e($trip->tripLandscape); ?></li>
                            <?php break; ?>

                            <?php case ('City'): ?>
                                <li class="text-dark" style="font-weight:bold;"><img
                                        src="<?php echo e(asset('assets/images/buildings.png')); ?>" class="icon" />
                                    <?php echo e($trip->tripLandscape); ?></li>
                            <?php break; ?>

                            <?php case ('Country Side'): ?>
                                <li class="text-dark" style="font-weight:bold;"><img
                                        src="<?php echo e(asset('assets/images/farm.png')); ?>" class="icon" />
                                    <?php echo e($trip->tripLandscape); ?></li>
                            <?php break; ?>

                            <?php case ('Mountainous'): ?>
                                <li class="text-dark" style="font-weight:bold;"><img
                                        src="<?php echo e(asset('assets/images/mountain.png')); ?>" class="icon" />
                                    <?php echo e($trip->tripLandscape); ?></li>
                            <?php break; ?>

                            <?php case ('Forested'): ?>
                                <li class="text-dark" style="font-weight:bold;"><img
                                        src="<?php echo e(asset('assets/images/forest.png')); ?>" class="icon" />
                                    <?php echo e($trip->tripLandscape); ?></li>
                            <?php break; ?>
                        <?php endswitch; ?>
                    </ul>
                ...
                <p class="trip-description" style="color: #000;"><?php echo e($trip->tripActivities); ?></p>
...
<?php /**PATH C:\xampp\htdocs\viveaventurascaribenas\resources\views//landing/destination.blade.php ENDPATH**/ ?>