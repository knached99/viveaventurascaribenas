...
Route::get('/vacation-agreement', [Home::class, 'vacationAgreement'])->name('vacation-agreement');
...
Route::get('/booking/cancel', [Home::class, 'bookingCancel'])->name('booking.cancel');
