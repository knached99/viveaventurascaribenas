                ...
                <form wire:submit.prevent="editTrip" class="p-4" enctype="multipart/form-data">
                    ...
                    <div class="text-center mb-4">
                        ...
                        @if (!is_null($replaceIndex))
                            ...
                            <button type="button" wire:click="replaceImage({{ $replaceIndex }})"
                    ...
                    <div class="mb-3">
                        ...
                        <textarea id="tripDescription" wire:model="tripDescription" class="form-control ckeditor" rows="4">{{ $this->tripDescription }}</textarea>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea id="tripActivities" wire:model="tripActivities" class="form-control ckeditor" rows="4">{{ $this->tripActivities }}</textarea>
