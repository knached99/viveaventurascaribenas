            ...
            <div class="card shadow-lg border-0 rounded-lg">
                ...
                <form wire:submit.prevent="editTrip" class="p-4" enctype="multipart/form-data">
                    ...
                    <div class="text-center mb-4">
                        <label for="tripPhoto" class="form-label fw-semibold">Trip Photo:</label>
                        <input type="file" wire:model="tripPhoto" id="tripPhoto" class="form-control-file mb-3 {{ $errors->has('tripPhoto') ? 'border-danger' : '' }}" />
                        <img src="{{ asset('storage/' . $trip->tripPhoto) }}" class="img-fluid img-thumbnail rounded shadow-sm" style="max-width: 300px; height: auto;" alt="{{ $trip->tripLocation }}" />
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" wire:model="tripLocation" id="tripLocation" class="form-control rounded-3 p-2 {{ $errors->has('tripLocation') ? 'border-danger' : '' }}" placeholder="Trip Location" value="{{ $trip->tripLocation }}" />
                    ...
                    <div class="mb-3">
                        ...
                        <textarea wire:model="tripDescription" id="tripDescription" class="form-control rounded-3 {{ $errors->has('tripDescription') ? 'border-danger' : '' }}" rows="5" placeholder="Enter trip description...">{{ $trip->tripDescription }}</textarea>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea wire:model="tripActivities" id="tripActivities" class="form-control rounded-3 {{ $errors->has('tripActivities') ? 'border-danger' : '' }}" rows="5" placeholder="Enter trip activities...">{{ $trip->tripActivities }}</textarea>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <select wire:model="tripLandscape" id="tripLandscape" class="form-select rounded-3 {{ $errors->has('tripLandscape') ? 'border-danger' : '' }}">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <select wire:model="tripAvailability" id="tripAvailability" class="form-select rounded-3 {{ $errors->has('tripAvailability') ? 'border-danger' : '' }}">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="date" wire:model="tripStartDate" id="tripStartDate" class="form-control rounded-3 {{ $errors->has('tripStartDate') ? 'border-danger' : '' }}" value="{{ $startDate }}" />
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="date" wire:model="tripEndDate" id="tripEndDate" class="form-control rounded-3 {{ $errors->has('tripEndDate') ? 'border-danger' : '' }}" value="{{ $endDate }}" />
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" wire:model="tripPrice" id="tripPrice" class="form-control rounded-3 {{ $errors->has('tripPrice') ? 'border-danger' : '' }}" value="{{ $trip->tripPrice }}" />
