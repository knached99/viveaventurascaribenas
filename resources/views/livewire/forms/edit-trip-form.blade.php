                ...
                <form wire:submit.prevent="editTrip" class="p-4" enctype="multipart/form-data">
                    ...
                    <div class="text-center mb-4">
                        ...
                        @if (!is_null($replaceIndex))
                            ...
                            <button type="button" wire:loading.remove="tripPhotos" wire:click="replaceImage({{ $replaceIndex }})"
                                class="btn btn-primary">
                                Replace Image
                            </button>

                            <div class="spinner-border text-primary" wire:loading="tripPhotos" role="status">
                    ...
                    {{-- @livewire('admincomponents.quill', ['value' => $this->tripDescription]) --}}
                        ...
                        <textarea id="tripDescription"  name="tripDescription" wire:model="tripDescription" class="form-control ckeditor" rows="4">{{ $this->tripDescription }}</textarea>
                    ...
                    {{-- @livewire('admincomponents.quill', ['value' => $this->tripActivities]) --}}
                        ...
                        <textarea id="tripActivities" name="tripActivities"  wire:model="tripActivities" class="form-control ckeditor" rows="4">{{ $this->tripActivities }}</textarea>
