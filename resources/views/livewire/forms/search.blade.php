    ...
    <form wire:submit.prevent="search">
        <div class="navbar-nav align-items-center">
            <div class="nav-item d-flex align-items-center position-relative">
                ...
                <span class="text-muted" wire:loading>loading search results...</span>
                                ...
                                @elseif(isset($result['bookingID']))
                                    ...
                                    <a href="{{ route('admin.booking', ['bookingID' => $result['bookingID'] ?? '']) }}"
                                        ...
                                        <li class="list-group-item p-2 border-bottom hover:bg-light cursor-pointer">
                                            ...
                                            <p class="mb-0 text-muted">{{ $result['email'] }} |
                                                {{ $result['phone_number'] }}</p>
                                    ...
                                    <a href="{{ route('admin.testimonial', ['testimonialID' => $result['testimonialID'] ?? '']) }}"
                                        ...
                                        <li class="list-group-item p-2 border-bottom hover:bg-light cursor-pointer">
                                            ...
                                            <p class="mb-0 text-muted">
                                                {{ \Str::limit($result['testimonial'] ?? 'No Testimonial', 100) }}</p>
                                        </li>
                                    </a>
                                @endif
                            @endforeach
