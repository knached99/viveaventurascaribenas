            ...
            <div class="col-md-8 col-lg-6">
                <div class="blog-entry p-4  shadow-md rounded bg-light">
                    <form class="row g-3" wire:submit.prevent="submitTestimonialForm">
                        ...
                        <div class="col-12">
                            <div class="form-group">
                                <input type="email" wire:model="email" class="form-control {{$errors->has('email') ? 'border border-danger' : ''}}" placeholder="Email (Optional, for follow-up only)">
                                @error('email')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                        ...
                        <div class="col-12">
                            <div class="form-group {{$errors->has('trip_rating') ? 'border border-danger' : ''}}">
                                <label class="form-label">Rate Your Experience (1-5 Stars)</label>
                                <div class="rating"> 
                                    <input wire:model="trip_rating" type="radio" name="rating" value="5" id="5">
                                    <label for="5">☆</label> 
                                    <input wire:model="trip_rating" type="radio" name="rating" value="4" id="4">
                                    <label for="4">☆</label> 
                                    <input wire:model="trip_rating" type="radio" name="rating" value="3" id="3">
                                    <label for="3">☆</label> 
                                    <input wire:model="trip_rating" type="radio" name="rating" value="2" id="2">
                                    <label for="2">☆</label> 
                                    <input wire:model="trip_rating" type="radio" name="rating" value="1" id="1">
                                    <label for="1">☆</label> 
                        ...
                        <div class="col-12">
                            <div class="form-group">
                                <textarea wire:model="testimonial" class="form-control {{$errors->has('testimonial') ? 'border border-danger' : ''}}" rows="7" placeholder="Tell us about your experience (What made your trip special?)"></textarea>
                                @error('testimonial')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                        ...
                        <div class="col-12">
                            <div class="form-group">
                                <button type="submit" class="btn btn-primary w-100 py-3" wire:loading.remove>Submit Testimonial</button>
