        ...
        <div class="flex items-center justify-between p-6">
            <div class="flex items-center space-x-4">
                <div class="flex items-center">
                    ...
                    <a href="{{ route('admin.trip', ['tripID' => $testimonial->trip->tripID]) }}">
                        <span
                            class="ml-2">{{ $testimonial->trip ? $testimonial->trip->tripLocation : 'Location not available' }}</span>
                    </a>
                </div>
                <div class="flex items-center">
                ...
                <div class="flex items-center space-x-1">
                    <i class='bx bx-envelope tet-lg'></i>
                    <a href="mailto:{{ $testimonial->email }}">Reply back to {{ $testimonial->name }}</a>
                </div>
            </div>
