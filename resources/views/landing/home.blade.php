        ...
        <div class="row">
            <div class="col-md-3 ftco-animate">
                <div class="project-destination">
                    <a href="#" class="img"
                        style="background-image: url({{ asset('assets/images/costaRica.jpg') }});">
                        <div class="text">
                            <h3>Costa Rica</h3>
                            <span>8 Tours</span>
                        </div>
            ...
            <div class="col-md-3 ftco-animate">
                <div class="project-destination">
                    <a href="#" class="img"
                        style="background-image: url({{ asset('assets/images/puertoRico.jpg') }});">
                        <div class="text">
                            <h3>Puerto Rico</h3>
                            <span>4 Tours</span>
                        </div>
            ...
            <div class="col-md-3 ftco-animate">
                <div class="project-destination">
                    <a href="#" class="img"
                        style="background-image: url({{ asset('assets/images/aruba.jpg') }});">
                        <div class="text">
                            <h3>Aruba</h3>
                            <span>5 Tours</span>
                        </div>
            ...
            <div class="col-md-3 ftco-animate">
                <div class="project-destination">
                    <a href="#" class="img"
                        style="background-image: url({{ asset('assets/images/mexico.jpg') }});">
                        <div class="text">
                            <h3>Mexico</h3>
                            <span>5 Tours</span>
                        </div>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-4 ftco-animate">
                <div class="project-wrap">
                    ...
                    <div class="text p-4">
                        ...
                        <h3><a href="#">Azure Beach, Aruba</a></h3>
                        <p class="location"><span class="ion-ios-map"></span> Azure Beach, Aruba</p>
                        <ul>
            ...
            <div class="col-md-4 ftco-animate">
                <div class="project-wrap">
                    <a href="#" class="img"
                        style="background-image: url({{ asset('assets/images/mexico.jpg') }});"></a>
                    <div class="text p-4">
                        <span class="price">$300/person</span>
                        <span class="days">10 Days Tour</span>
                        <h3><a href="#">Mexico City, Mexico</a></h3>
                        <p class="location"><span class="ion-ios-map"></span> Mexico City, Mexico</p>
                        <ul>
                            <li><span class="flaticon-shower"></span>2</li>
                            <li><span class="flaticon-king-size"></span>3</li>
                            <li><span class="flaticon-sun-umbrella"></span>City</li>
                        </ul>
                    </div>
                </div>
            </div>
            <div class="col-md-4 ftco-animate">
                <div class="project-wrap">
                    <a href="#" class="img"
                        style="background-image: url({{ asset('assets/images/costaRica.jpg') }});"></a>
                    <div class="text p-4">
                        <span class="price">$300/person</span>
                        <span class="days">7 Days Tour</span>
                        <h3><a href="#">Manuel Antonio, Costa Rica</a></h3>
                        <p class="location"><span class="ion-ios-map"></span> Manuel Antonio, Costa Rica</p>
                        <ul>
                            <li><span class="flaticon-shower"></span>2</li>
                            <li><span class="flaticon-king-size"></span>3</li>
                            <li><span class="flaticon-sun-umbrella"></span>Near Beach</li>
            ...
            <div class="col-md-4 ftco-animate">
                <div class="project-wrap">
                    <a href="#" class="img"
                        style="background-image: url({{ asset('assets/images/puertoRico.jpg') }});"></a>
                    <div class="text p-4">
                        <span class="price">$300/person</span>
                        <span class="days">8 Days Tour</span>
                        <h3><a href="#">Flamenco Beach, Puerto Rico</a></h3>
                        <p class="location"><span class="ion-ios-map"></span>Flamenco Beach, Puerto Rico</p>
                        <ul>
                            <li><span class="flaticon-shower"></span>2</li>
                            <li><span class="flaticon-king-size"></span>3</li>
                            <li><span class="flaticon-sun-umbrella"></span>Near Beach</li>
            ...
            <div class="col-md-4 ftco-animate">
                <div class="project-wrap">
                    <a href="#" class="img"
                        style="background-image: url({{ asset('assets/images/bahamas.jpg') }});"></a>
                    <div class="text p-4">
                        <span class="price">$300/person</span>
                        <span class="days">10 Days Tour</span>
                        <h3><a href="#">Floating Huts, Bahamas</a></h3>
                        <p class="location"><span class="ion-ios-map"></span> Floating Huts, Bahamas</p>
                        <ul>
                            <li><span class="flaticon-shower"></span>2</li>
                            <li><span class="flaticon-king-size"></span>3</li>
                            <li><span class="flaticon-sun-umbrella"></span>Near Beach</li>
            ...
            <div class="col-md-4 ftco-animate">
                <div class="project-wrap">
                    <a href="#" class="img"
                        style="background-image: url({{ asset('assets/images/atlantis-bahamas.png') }});"></a>
                    <div class="text p-4">
                        <span class="price">$300/person</span>
                        <span class="days">7 Days Tour</span>
                        <h3><a href="#">Atlantis, Bahamas</a></h3>
                        <p class="location"><span class="ion-ios-map"></span> Atlantis, Bahamas</p>
                        <ul>
                            <li><span class="flaticon-shower"></span>2</li>
                            <li><span class="flaticon-king-size"></span>3</li>
                            <li><span class="flaticon-sun-umbrella"></span>Near Beach</li>
