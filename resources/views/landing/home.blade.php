...
<div class="hero-wrap js-fullheight" style="background-image: url('{{ asset('assets/images/campeche_mexico_sign.jpg') }}');"
    ...
    <div class="container">
        <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-center"
            ...
            <div class="col-md-9 text text-center ftco-animate" data-scrollax=" properties: { translateY: '70%' }">
                ...
                <p class="caps" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }">Beyond the Ordinary,
    ...
    <div class="container">
        <div class="row d-flex">
            ...
            <div class="col-12 col-md-6 order-md-last heading-section pl-md-5 ftco-animate">
                ...
                <p>Welcome to Vive Aventuras Caribeñas, your gateway to unforgettable travel experiences in the
                    ...
                    Our mission is to offer you experiences that leave a lasting impression, making each trip a memory
                    you’ll cherish forever.</p>
                <p><a href="{{ route('destinations') }}" class="btn btn-primary py-3 px-4">Book a Travel</a></p>

                <div class="m-5"
                    style="background-image:url({{ asset('assets/images/isla_aguada.webp') }}); background-size: contain; background-repeat: no-repeat; background-position: center; width: 100%; height: 800px; max-height: 800px;">
                </div>
            </div>
                    ...
                    <div class="col-12 col-md-6 d-flex align-self-stretch ftco-animate">
                        <div class="media block-6 services d-block">
                            ...
                            <div class="media-body">
                                ...
                                <p>At Vive Aventuras Caribeñas, we pride ourselves on offering safe and convenient
                                    travel arrangements designed to
                                    provide our travelers with unparalleled comfort and unforgettable experiences.
                                    From personalized itineraries to exclusive accommodations and private
                                    transportation,
                    ...
                    <div class="col-12 col-md-6 d-flex align-self-stretch ftco-animate">
                        <div class="media block-6 services d-block">
                            ...
                            <div class="media-body">
                                ...
                                <p>We provide you with a diverse array of activities, perfect for every type of
                                    traveler.
                        ...
                        <div class="media block-6 services d-block">
                            ...
                            <div class="media-body">
                                ...
                                <p>Feel confident in the measures we take to provide you with safety and convenience
                                    ...
                                    With a simple request, enjoy access to beautiful beaches, restaurants, and much
                                    more.
                                </p>
                            </div>
                        </div>
            ...
            <div class="col-md-6 pl-md-5 py-5">
                <div class="row justify-content-start pb-3">
                    <div class="col-md-12 heading-section ftco-animate">
                        ...
                        <p>At Vive Aventuras Caribeñas, we’re dedicated to helping you embrace new adventures with
                            excitement and ease.
                            Our experts will thoughtfully craft itineraries designed to offer you a journey filled with
                            discovery, fun, and unique experiences.
                            Every moment is an opportunity to explore something new, immerse yourself in vibrant
                            cultures,
                            and create lasting memories—all while enjoying the thrill of the unknown without a care in
                            the world.
