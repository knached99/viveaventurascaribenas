        ...
        <div class="row">
            <div class="col-md-8">
                ...
                <div class="trip-details">
                    ...
                    <div class="text-description"> {!! $trip->tripDescription !!}</div>
                ...
                <div class="text-description">{!! $trip->tripActivities !!}</div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <livewire:forms.testimonial-form :tripID="$trip->tripID" :isHomePage='$isHomePage' />
                </div>
