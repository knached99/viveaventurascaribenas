...
class Home extends Controller
{
    ...
    public function destinationsPage(){
        // Fetch all trips
        $trips = TripsModel::select('tripID', 'tripLocation', 'tripPhoto', 'tripLandscape', 'tripAvailability', 'tripStartDate', 'tripEndDate', 'tripPrice', 'slug', 'num_trips', 'square_product_id')->where('active', true)->get();
